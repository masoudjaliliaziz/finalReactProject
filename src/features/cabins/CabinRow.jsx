...
import { useDeleteRowCabin } from "./hooks/useDeleteRowCabin";
...
function CabinRow({ cabin }) {
  const { deleteCabin, isDeleting } = useDeleteRowCabin();
  ...
  return (
    <>
      <TableRow role="row">
        ...
        <div>
          <button disabled={createIsPending} onClick={handleDuplicate}>
            <HiSquare2Stack />
          </button>
          <button
            onClick={() => {
